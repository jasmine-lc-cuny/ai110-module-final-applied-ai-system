...
from app_common import COMMON_TASK_TITLES, get_owner, get_scheduler, save_owner, task_rows

owner = get_owner()
scheduler = get_scheduler()

st.title("🐾 My Pets & Schedule")
st.caption("Add and manage pets, schedule and edit tasks, and see today's full schedule.")
...
save_owner(owner)
st.caption(f"Data is auto-saved to `data.json` after every change, so it persists between app runs.")
